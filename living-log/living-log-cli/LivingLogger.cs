...
namespace living_log_cli
{
    public class LivingLogger : Logger
    {
        ...
        public void Start() { Invoke(Categories.LivingLog_Startup, new SyncData() { Timestamp = DateTime.UtcNow, Version = "1" }); }
        public void Stop() { Invoke(Categories.LivingLog_Exit, new SyncData() { Timestamp = DateTime.UtcNow, Version = "1" }); }
